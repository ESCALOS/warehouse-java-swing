...
import com.nanoka.almacenrepuestos.services.SupplierService;
import com.nanoka.almacenrepuestos.tables.SupplierTable;
...
public class SupplierFrame extends javax.swing.JFrame {
    ...
    private final SupplierTable supplierTableModel;
    /**
     * Creates new form Supplier
     */
    public SupplierFrame() {
        initComponents();
        suppliers.addAll(supplierService.getSuppliers());
        supplierTableModel = new SupplierTable(suppliers);
        supplier_table.setModel(supplierTableModel);
    }
    ...
    private void btn_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_searchActionPerformed
        ...
        if(txt_search.getText().isEmpty()) {
            ...
            this.suppliers.addAll(supplierService.search( txt_search.getText()));
        }
        supplierTableModel.fireTableDataChanged();
    ...
    private void btn_addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_addActionPerformed
        /*SupplierForm supplierForm = new SupplierForm(this, true);
    ...
    private void btn_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_updateActionPerformed
        ...
        if(selectedRow != -1) {
            int id = this.suppliers.get(selectedRow).getId();
            //SupplierForm supplierForm = new SupplierForm(this, true, id, selectedRow,supplier_table.getValueAt(selectedRow, 0).toString());
            //supplierForm.setVisible(true);
        }else{
